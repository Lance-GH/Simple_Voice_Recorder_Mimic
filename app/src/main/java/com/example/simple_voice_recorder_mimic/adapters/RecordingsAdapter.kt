package com.example.simple_voice_recorder_mimic.adapters
...
import com.example.simple_voice_recorder_mimic.BuildConfig
import com.example.simple_voice_recorder_mimic.R
import com.example.simple_voice_recorder_mimic.activities.SimpleActivity
import com.example.simple_voice_recorder_mimic.dialogs.RenameRecordingDialog
...
class RecordingsAdapter(
    ...
    override fun getActionMenuId(): Int = R.menu.cab_recordings
    ...
    override fun getSelectableItemCount(): Int = recordings.size
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
        createViewHolder(R.layout.item_recording, parent)
    ...
    private fun setupView(view: View, recording: Recording) {
        view.apply {
            ...
            arrayListOf<TextView>(recording_title, recording_date, recording_size).forEach {
